...
*/
#include "ss_dsi_panel_S6E3HA9_AMB666WS04.h"
#include "ss_dsi_mdnie_S6E3HA9_AMB666WS04.h"
#include "ss_dsi_interpolation_S6E3HA9_AMB666WS04.h"
...
static void samsung_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E3HA9_AMB666WS04;

	/* GAMMA FLASH */
	vdd->panel_func.gen_hbm_interpolation_gamma = gen_hbm_interpolation_gamma_S6E3HA9_AMB666WS04;
	vdd->panel_func.gen_hbm_interpolation_irc = gen_hbm_interpolation_irc_S6E3HA9_AMB666WS04;
	vdd->panel_func.gen_normal_interpolation_irc = gen_normal_interpolation_irc_S6E3HA9_AMB666WS04;
	vdd->panel_func.samsung_flash_gamma_support = flash_gamma_support_S6E3HA9_AMB666WS04;
	vdd->panel_func.samsung_interpolation_init = init_interpolation_S6E3HA9_AMB666WS04;
	...
	vdd->panel_func.samsung_smart_get_conf_hmt = smart_get_conf_S6E3HA9_AMB666WS04_hmt;
...
static int __init samsung_panel_initialize(void)
{
	...
	char panel_string[] = "ss_dsi_panel_S6E3HA9_AMB666WS04_WQHD";
