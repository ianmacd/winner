...
#if defined(CONFIG_SEC_WINNERLTE_PROJECT) || defined(CONFIG_SEC_WINNERX_PROJECT) || defined(CONFIG_SEC_D2Q_PROJECT)
extern unsigned int sec_hw_rev(void);
#endif
#if defined(CONFIG_SEC_WINNERLTE_PROJECT)
#define CRITERION_REV	(8)
#elif defined(CONFIG_SEC_WINNERX_PROJECT) || defined(CONFIG_SEC_D2Q_PROJECT)
...
#if !defined(CONFIG_SEC_WINNERLTE_PROJECT) && !defined(CONFIG_SEC_WINNERX_PROJECT) && !defined(CONFIG_SEC_BEYONDXQ_PROJECT)
