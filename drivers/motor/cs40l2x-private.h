...
#define EVENT_DIG_SCALE_FOLDER_CLOSE_SHORT_DURATION	5
#define EVENT_DIG_SCALE_FOLDER_CLOSE_LONG_DURATION	5
#else
#define EVENT_DIG_SCALE_FOLDER_CLOSE_SHORT_DURATION	0
#define EVENT_DIG_SCALE_FOLDER_CLOSE_LONG_DURATION	0
#endif
#if defined(CONFIG_SEC_WINNERLTE_PROJECT) || defined(CONFIG_SEC_WINNERX_PROJECT)
#define EVENT_DIG_SCALE_FOLDER_OPEN_SHORT_DURATION	30
#define EVENT_DIG_SCALE_FOLDER_OPEN_LONG_DURATION	63
#else
#define EVENT_DIG_SCALE_FOLDER_OPEN_SHORT_DURATION	30
